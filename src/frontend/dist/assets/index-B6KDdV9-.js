const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Dashboard-CVbPQq09.js","assets/api-DS5_eO34.js","assets/index-B6VuHpqp.js","assets/AlertBadge-c2EvalJ8.js","assets/zap-BVqVJSOS.js","assets/refresh-cw-BWO3MCwL.js","assets/simulation-pFUAvvNh.js","assets/Processes-D0mfCc0p.js","assets/label-CoZ83f5O.js","assets/Logs-hFJR14_a.js","assets/Simulation-N6xvi52x.js"])))=>i.map(i=>d[i]);
...
function Layout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen bg-background overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "w-56 bg-sidebar border-r border-sidebar-border flex flex-col shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 px-4 py-4 border-b border-sidebar-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded bg-accent/20 border border-accent/40 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "w-4 h-4 text-accent" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-bold font-display text-sidebar-foreground tracking-wide", children: "ResourceFlow" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground font-mono", children: "v1.0 · live" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex-1 px-2 py-3 space-y-0.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-widest text-muted-foreground px-2 pb-1.5 pt-1", children: "Monitoring" }),
        NAV_ITEMS.map(({ to, label, icon: Icon2, ocid }) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to,
              "data-ocid": ocid,
              className: `flex items-center gap-2.5 px-2.5 py-2 rounded text-sm transition-smooth group ${isActive ? "bg-accent/15 text-accent border border-accent/25" : "text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-foreground"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Icon2,
                  {
                ...
                isActive && /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-3 h-3 ml-auto text-accent/70" })
              ]
            },
            to
          );
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-2 py-3 space-y-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "bg-card border-b border-border px-6 py-3 flex items-center justify-between shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-sm font-semibold text-foreground font-display", children: ((_a2 = NAV_ITEMS.find(
            (n) => n.to === "/" ? currentPath === "/" : currentPath.startsWith(n.to)
          )) == null ? void 0 : _a2.label) ?? "ResourceFlow" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-green-400 animate-pulse" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground font-mono", children: "live" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-[11px] text-muted-foreground font-mono bg-muted/30 border border-border px-2.5 py-1 rounded", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Policy:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-semibold uppercase", children: "RF+ML" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 overflow-auto bg-background", children }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-card border-t border-border px-6 py-2 flex items-center justify-between shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] text-muted-foreground font-mono", children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " ResourceFlow. Built with",
          " ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground font-mono", children: "Refresh: 1s · ML: 2s" })
      ] })
    ] })
  ] });
}
const DashboardPage = reactExports.lazy(() => __vitePreload(() => import("./Dashboard-CVbPQq09.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0));
const ProcessesPage = reactExports.lazy(() => __vitePreload(() => import("./Processes-D0mfCc0p.js"), true ? __vite__mapDeps([7,1,8,5,2,4]) : void 0));
const LogsPage = reactExports.lazy(() => __vitePreload(() => import("./Logs-hFJR14_a.js"), true ? __vite__mapDeps([9,1,3,5]) : void 0));
const SimulationPage = reactExports.lazy(() => __vitePreload(() => import("./Simulation-N6xvi52x.js"), true ? __vite__mapDeps([10,1,8,6,4]) : void 0));
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-48" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-4", children: Array.from({ length: 4 }, (_, i) => `skel-${i}`).map((key) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-24" }, key)) }),
...
const rootRoute = createRootRoute({
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "app.page", className: "h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }) }) })
});
...
const processesRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/processes",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProcessesPage, {}) })
});
const logsRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/logs",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(LogsPage, {}) })
});
const simulationRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/simulation",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimulationPage, {}) })
});
